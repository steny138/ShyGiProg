System.register(['angular2/platform/browser', './member.component', './services/MemberServices', './menu.component', './services/MenuServices', 'angular2/http', 'rxjs/add/operator/map'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var browser_1, member_component_1, MemberServices_1, menu_component_1, MenuServices_1, http_1;
    return {
        setters:[
